    ...
    <main className="min-h-screen flex flex-col max-w-[1280px] mx-auto px-5">
      ...
      <section className="w-full mx-auto  py-20 lg:py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12  ">
          <div className="text-center space-y-4 bg-primary-blue rounded-[24px] p-10 max-h-[526px]">
          ...
          <div className="relative rounded-[20px] overflow-hidden aspect-[1/1.06] w-full max-h-[526px]">
            <Image
              src="/ourmission1.png"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-primary-light-blue rounded-[24px] p-8 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
              >
        ...
        <div className="">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamRoles.map((team, index) => (
              <div
                key={index}
                className="bg-primary-light-blue rounded-[24px] p-8 text-center shadow-lg"
              >
