...
const Achievement = () => {
  return (
    <section className=" mt-[50px] flex gap-[24px] w-full flex-col md:flex-row">
        ...
        >
          <div className="flex ">
          <p className="text-[48px] font-bold">234</p>
          <svg className="mt-2 ml-1" width="27" height="23" viewBox="0 0 27 23" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.82013e-05 22.4004L4.35208 0.000389099H7.58408L13.0401 14.3524L18.4961 0.000389099H21.7281L26.0801 22.4004H22.0961L19.4081 8.54439L14.3681 21.8884H11.6961L6.65608 8.54439L3.98408 22.4004H7.82013e-05Z" fill="#0A1519"/>
</svg>
        ...
        >
         <div className="flex ">
          ...
          <svg className="mt-2 ml-1" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
