    ...
    <>
      ...
      <div className="bg-primary-blue">
        <div className="container px-5 py-4 flex justify-center md:justify-between items-center max-w-[1280px] mx-auto">
          <p className="text-white text-[10px] font-bold hidden md:block">{siteData.tagline}</p>
          <div className="flex items-center">
            <div className="flex items-center gap-2 border-r border-white pr-4">
              ...
              <a href={`tel:${siteData.phone}`} className="text-white text-[10px]">{siteData.phone}</a>
            </div>
            <div className="flex items-center gap-2 pl-4">
              ...
              <a href={`mailto:${siteData.email}`} className="text-white text-[10px]">{siteData.email}</a>
            </div>
          </div>
      ...
      <header className="bg-white py-5 md:py-10 px-5 sticky top-0 z-50">
        ...
        <nav
          className={`md:hidden fixed top-0 right-0 h-full w-[75%] max-w-[320px] bg-white z-50 shadow-2xl flex flex-col pt-24 px-6 gap-2 transition-transform duration-300 ease-in-out ${
