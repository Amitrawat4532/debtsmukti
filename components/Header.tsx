        ...
        <div className="container px-5 py-4 flex justify-center md:justify-between items-center max-w-[1280px] mx-auto">
          ...
          <div className="flex items-center">
            <div className="flex items-center gap-2 border-r border-white pr-4">
              ...
              <a href={`tel:${siteData.phone}`} className="text-white text-[16px] font-bold">{siteData.phone}</a>
            </div>
            <div className="flex items-center gap-2 pl-4">
              ...
              <a href={`mailto:${siteData.email}`} className="text-white text-[16px] font-bold">{siteData.email}</a>
            </div>
          </div>
